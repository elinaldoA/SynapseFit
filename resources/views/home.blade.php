        ...
        <div class="col-6 mb-4">
            <div class="card shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        @if ($imc < 18.5)
                            <span class="text-danger">Abaixo do peso</span> - Recomenda-se aumentar a ingestão calórica com foco em alimentação rica em proteínas e carboidratos.
                        @elseif ($imc >= 18.5 && $imc < 24.9)
                            <span class="text-success">Peso normal</span> - Continue mantendo hábitos saudáveis.
                        @elseif ($imc >= 25 && $imc < 29.9)
                            <span class="text-warning">Sobrepeso</span> - Considerar aumento de atividades físicas, focando em exercícios aeróbicos e musculação.
                        @elseif ($imc >= 30 && $imc < 34.9)
                            <span class="text-danger">Obesidade grau 1</span> - É importante buscar um plano alimentar controlado, com aumento da atividade física.
                        @elseif ($imc >= 35 && $imc < 39.9)
                            <span class="text-danger">Obesidade grau 2</span> - Aconselha-se acompanhamento médico e nutricional.
                        @else
                            <span class="text-danger">Obesidade grau 3</span> - Aconselha-se avaliação médica imediata para definir um plano de tratamento.
                        @endif
                    </p>
                </div>
            </div>
                    ...
                    <p class="card-text">
                        @if (Auth::user()->sex == 'masculino')
                            @if ($percentualGordura >= 25)
                                <span class="text-danger">Excesso de gordura</span> - Considerar redução do consumo de gorduras saturadas e aumento da atividade física.
                            @elseif ($percentualGordura >= 10 && $percentualGordura <= 20)
                                <span class="text-success">Percentual saudável</span> - Manter alimentação equilibrada e treinos.
                            @elseif ($percentualGordura < 10)
                                <span class="text-info">Atleta</span> - Continue com seu regime de treinamento e alimentação.
                            @endif
                        @else
                            @if ($percentualGordura >= 32)
                                <span class="text-danger">Excesso de gordura</span> - Considerar dieta balanceada com redução de gorduras e aumento de atividades físicas.
                            @elseif ($percentualGordura >= 20 && $percentualGordura <= 30)
                                <span class="text-success">Percentual saudável</span> - Excelente! Mantenha a rotina de exercícios e alimentação equilibrada.
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        @if ($massaMagra > 0 && $massaMagra < 50)
                            <span class="text-warning">Baixa</span> - Recomenda-se focar no treino de musculação para aumento de massa muscular.
                        @elseif ($massaMagra >= 50 && $massaMagra <= 75)
                            <span class="text-success">Média</span> - Excelente! Continue com seu treino de força e alimentação rica em proteínas.
                        @else
                            <span class="text-info">Alta</span> - Continue com seu regime, mas sempre mantenha o equilíbrio no treino e alimentação.
                        @endif
                    </p>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        @if ($massaGordura > 0 && $massaGordura < 20)
                            <span class="text-success">Baixa</span> - Isso é ótimo! Continue com sua alimentação balanceada e treinos consistentes.
                        @elseif ($massaGordura >= 20 && $massaGordura <= 30)
                            <span class="text-warning">Média</span> - Continue com sua dieta e atividades físicas para manter esse nível saudável.
                        @else
                            <span class="text-danger">Alta</span> - Considere um plano de emagrecimento, focando em exercícios cardiovasculares e dieta.
                        @endif
                    </p>
                </div>
            </div>
        ...
        <div class="col-6 mb-4">
            <div class="card shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        @if ($visceralFat > 12)
                            <span class="text-danger">Excesso de gordura visceral</span> - É importante trabalhar para reduzir a gordura visceral com exercícios e dieta.
                        @else
                            <span class="text-success">Faixa saudável</span> - Continue mantendo seus hábitos saudáveis.
                        @endif
                    </p>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        @elseif ($idadeCorporal <= 40)
                            <span class="text-warning">Moderada</span> - Pode ser interessante avaliar seu estilo de vida.
                        @else
                            <span class="text-danger">Acima da média</span> - Considere ajustes para melhorar sua saúde.
                        @endif
                    </p>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        @if ($impedanciaSegmentos !== 'Não disponível')
                            ...
                            @else
                                <span class="text-danger">Excesso de gordura</span> - Trabalhe para reduzir a gordura corporal.
                            @endif
                        @else
    ...
    <script>
        ...
        var bioimpedanceChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Bioimpedância',
                    data: [{{$imc}}, {{$percentualGordura}}, {{$pesoIdealSuperior}}, {{$massaMagra}}, {{$massaGordura}}],
